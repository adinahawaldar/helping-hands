...
const Hero = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="relative bg-white pt-20 md:pt-28 pb-20 border-b border-neutral-100 overflow-hidden">
        {/* Title & Description Container */}
        <div className="max-w-6xl mx-auto px-6 text-center flex flex-col items-center gap-6">
          <h1 className="font-serif text-[2.5rem] min-[380px]:text-[3rem] sm:text-[3.85rem] md:text-[4.5rem] font-bold tracking-tight text-[#1A1A18] leading-[1.1] w-full flex flex-col items-center">
      ...
      <div id="about-us" className="bg-white py-20 border-b border-neutral-100">
